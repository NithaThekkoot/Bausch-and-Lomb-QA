({
                ...
                if (response.getState() == 'SUCCESS') {
                    ...
                    for (var i = 0; i < cleanObjectArray.length; i++) {
                        ...
                        if (responseValue[i].success == false) {
                            ...
                            errorList[errorCount]["errorMessages"] = responseValue[i].errorCodeList;
    ...
    readRaw: function(component, event, helper, query, callbackFunction) {
        ...
        if (inputErrorArray.length == 0) {
            ...
            if(self.readChaching){
                readAction.setStorable();
            }
    ...
    getCurrentUserDetails : function(component, event, helper,callback){
        ...
        if ((input !== undefined) && (input !== null) && (Array.isArray(input))) {
                ...
                if (Array.isArray(input[0])) {
                    ...
                    for (var i = 0; i < input.length; i++) {
                        ...
                        for (key in inputObject) {
                            ...
                            if ((key != "sobjectType") && (!this.strEndsWith(key, "__r")) && (typeof(inputObject[key]) != "object" || inputObject[key] === null)) {
            ...
            if (typeof(input) == "object") {
                ...
                for (var key in input) {
                    ...
                    if ((key != "sobjectType") && (!this.strEndsWith(key, "__r")) && (typeof(input[key]) != "object" || input[key] === null)) {
    ...
    cleanForUpdate: function(input) {
        ...
        if ((input !== undefined) && (input !== null) && (Array.isArray(input))) {
                ...
                if (input[0].constructor == Array) {
                    ...
                    for (var i = 0; i < input.length; i++) {
                        ...
                        for (var key in inputObject) {
                            if ((key != "sobjectType") && (key != "Id") && (!this.strEndsWith(key, "__r")) && (typeof(inputObject[key]) != "object" || inputObject[key] === null)) {
                                cleanObject[key] = inputObject[key];
                            }
                        }
                        // assign clean object in clean array
            ...
            if (typeof(input) == "object") {
                ...
                // add other attributes in this object
                for (var key in input) {
                    if ((key != "Id") && (key != "sobject") && (!this.strEndsWith(key, "__r")) && (typeof(input[key]) != "object" || input[key] === null)) {
                        cleanObject[key] = input[key];
                    }
                }
